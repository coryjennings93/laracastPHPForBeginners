                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php else : ?>
                                <a href="/register" class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium">Register</a>
                                <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium">Log In</a>
                            <?php endif; ?>
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="ml-3">
                            <!-- here you are ending the user's session so you want a delete request to delete the session data -->
